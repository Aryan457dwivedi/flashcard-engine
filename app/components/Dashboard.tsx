...
// ── Stacked bar (mastered / learning / struggling) ───────────────────────
function StackBar({
  ...
  return (
    <div style={{
      ...
      {mastered   > 0 && <div style={{ width: `${pct(mastered)}%`,   background: 'var(--sb-a, #0f0f1a)',              transition: 'width 0.7s ease' }} />}
      {learning   > 0 && <div style={{ width: `${pct(learning)}%`,   background: 'var(--sb-b, rgba(15,15,26,0.45))', transition: 'width 0.7s ease' }} />}
      {struggling > 0 && <div style={{ width: `${pct(struggling)}%`, background: 'var(--sb-c, rgba(15,15,26,0.18))', transition: 'width 0.7s ease' }} />}
    </div>
  );
}
    ...
    <div style={{ fontFamily: "'DM Sans', sans-serif", color: '#0f0f1a', display: 'flex', flexDirection: 'column', gap: '10px' }}>
      ...
      <div style={{
        ...
        <div>
          <div style={{
            ...
            fontSize: '10.5px', fontWeight: '500', color: 'rgba(15,15,26,0.4)',
            textTransform: 'uppercase', letterSpacing: '0.1em',
            marginBottom: '16px',
          }}>
            <span style={{ width: '5px', height: '5px', borderRadius: '50%', background: 'rgba(15,15,26,0.3)' }} />
            Learning intelligence &nbsp;·&nbsp; {trend}
          </div>

          <div style={{ fontSize: '11px', fontWeight: '500', color: 'rgba(15,15,26,0.4)', textTransform: 'uppercase', letterSpacing: '0.1em', marginBottom: '6px' }}>
            Learning score
          </div>
          <div style={{ fontSize: '72px', fontWeight: '500', letterSpacing: '-3px', color: '#0f0f1a', lineHeight: 1, marginBottom: '6px' }}>
            {learningScore}
          </div>
          <div style={{ fontSize: '18px', fontWeight: '500', color: '#0f0f1a', marginBottom: '24px' }}>
            {heroStatus}
          </div>
          ...
          <div style={{ display: 'flex', gap: '0' }}>
            {[
              ...
              <div key={s.label} style={{
                ...
                borderRight:  i < 3 ? '1px solid rgba(15,15,26,0.08)' : 'none',
              }}>
                <div style={{ fontSize: '20px', fontWeight: '500', color: '#0f0f1a', lineHeight: 1 }}>{s.value}</div>
                <div style={{ fontSize: '10.5px', color: 'rgba(15,15,26,0.4)', marginTop: '3px', textTransform: 'uppercase', letterSpacing: '0.08em' }}>{s.label}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Ring */}
        <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#0f0f1a' }}>
          <Ring pct={mastPct} size={140} />
          <div style={{ position: 'absolute', textAlign: 'center' }}>
            <div style={{ fontSize: '26px', fontWeight: '500', color: '#0f0f1a', lineHeight: 1 }}>{mastPct}%</div>
            <div style={{ fontSize: '9px', fontWeight: '500', color: 'rgba(15,15,26,0.4)', textTransform: 'uppercase', letterSpacing: '0.1em', marginTop: '3px' }}>mastery</div>
          </div>
        </div>
      </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10px' }}>
        {[
          ...
          <div key={label} style={{ ...PANEL, padding: '18px 20px' }}>
            ...
            <div style={{ fontSize: '28px', fontWeight: '500', color: '#0f0f1a', lineHeight: 1, margin: '8px 0 12px' }}>{val}</div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '13px', color: 'rgba(15,15,26,0.55)', lineHeight: 1.55 }}>
            {insight.text}
          </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <svg width="16" height="16" fill="none" stroke="rgba(15,15,26,0.5)" strokeWidth="1.6"
            strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
        ...
        <div>
          ...
          <div style={{ fontSize: '14px', fontWeight: '500', color: '#0f0f1a', marginBottom: '4px' }}>
            {coach.title}
          </div>
          <div style={{ fontSize: '13px', color: 'rgba(15,15,26,0.55)', lineHeight: 1.55 }}>
            {coach.text}
